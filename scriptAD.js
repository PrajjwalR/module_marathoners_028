...
function changeStats(company, clickedLogo) {
    ...
    setTimeout(() => {
        document.getElementById('percentage1').innerText = statsData[company].percentage1;
        document.getElementById('description1').innerText = statsData[company].description1;
        document.getElementById('percentage2').innerText = statsData[company].percentage2;
        document.getElementById('description2').innerText = statsData[company].description2;
        document.getElementById('percentage3').innerText = statsData[company].percentage3;
        document.getElementById('description3').innerText = statsData[company].description3;
